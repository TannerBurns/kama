...
[reporting form](https://github.com/TannerBurns/kama/security/advisories/new). Prefix
the report title with `Code of Conduct`. If the form is unavailable, ask the
repository owner for a private reporting channel without including sensitive details.
